<template>
	<el-container class="home-page">
		<el-aside width="80px" class="navi-bar">
			...
			<el-menu  text-color="#ddd" style="margin-top: 30px;background-color:#333">
...
.navi-bar {
	...
	.el-menu {
		...
		.el-menu-item {
			...
			.router-link-exact-active span {
				color: rgb(18, 140, 227) !important;
			}
			...
			span {
				...
				&:hover {
					color: rgb(89, 153, 230) !important;
				}
			}
	...
	.exit-box {
		...
		&:hover {
			color: rgb(85, 171, 251) !important;
		}
	}
}
