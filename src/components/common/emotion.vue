		...
		<div class="emotion-box" :style="{ 'left': x + 'px', 'top': y + 'px' }">
			<el-scrollbar style="height:250px">
				<div class="emotion-item-list">
					<div class="emotion-item" v-for="(emoText, i) in emoTextList" :key="i"
						@click="onClickEmo(emoText)" v-html="textToImg(emoText)">
					</div>
				</div>
			</el-scrollbar>
		</div>
...
<script>
import { emoTextList, textToImg } from '../../api/emotion';
