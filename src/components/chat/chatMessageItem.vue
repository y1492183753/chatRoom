	...
	<div class="chat-msg-item">
		...
		<div class="chat-msg-normal" v-show="msgInfo.type >= 0 && msgInfo.type < 10" :class="{ 'chat-msg-mine': mine }">
			<div class="head-image">
				<headImage :name="showName" :size="40" :url="headImage" :id="msgInfo.sendId"></headImage>
			</div>
		...
		<rightMenu v-show="menu && rightMenu.show" :pos="rightMenu.pos" :items="menuItems" @close="rightMenu.show = false"
			@select="onSelectMenu"></rightMenu>
		<chatGroupReaded ref="chatGroupReadedBox" :msgInfo="msgInfo" :groupMembers="groupMembers"></chatGroupReaded>
	</div>
</template>
...
import chatGroupReaded from '../chat/chatGroupReaded.vue';
export default {
	name: "messageItem",
	components: {
		headImage,
